...
LOAD_MODEL=/nas2/lishengping/models/pretrain_models/gpt2-chinese/$SIZE
# rotary emb
...
LOAD_MODEL=/nas2/lishengping/caiyun_projects/gpt2-chinese/pretrain_t2023_12_06_13_pos0_ner0_prompt0_base/step16000
LOAD_MODEL=/nas2/lishengping/caiyun_projects/gpt2-chinese/pretrain_t2023_12_06_14_pos0_ner0_prompt0_Rotary_base/step36000


# TRAIN_PATH=/nas2/lishengping/data/med_data/data_with_pos_ner/1205/train.jsonl
TRAIN_PATH=/nas2/lishengping/data/med_data/data_with_pos_ner/train.jsonl
EVAL_PATH=/nas2/lishengping/data/med_data/data_with_pos_ner/test.jsonl
EVAL_PATH=/nas2/lishengping/data/med_data/data_with_pos_ner/books.pdf.jsonl


# TRAIN_PATH=/nas2/lishengping/data/med_data/data_with_pos_ner/IMCS.jsonl
# EVAL_PATH=/nas2/lishengping/data/med_data/data_with_pos_ner/IMCS.jsonl
...
LOG_NAME="$skip_step"step_"$POS_EMB"_"$MAX_LEN"_"$BASE2"
